...
const cateringSectionCard = (section, index) => `
  <details class="catering-menu-card" name="catering-sections">
    <summary>
      ...
      <span class="catering-menu-card__count">${section.items.length} selections<span class="catering-menu-card__hint"><span class="catering-menu-card__hint-closed">Open card</span><span class="catering-menu-card__hint-open">Close card</span></span></span>
    </summary>
...
export const pages = [
  ...
  },
  {
    ...
    body: `
      <section class="page-hero page-hero--catering"><div class="wrap"><p class="eyebrow">Shelly’s catering</p><h1>Catering that brings everyone to the table.</h1><p>From fresh bannock platters and boxed lunches to comfort-food dinners and recurring meal programs, Shelly’s brings generous food to your gathering.</p><div class="actions">${action('#catering-menu', 'Explore the catering menu')}${action(business.phoneHref, 'Call about catering', 'button--light')}</div></div></section>
